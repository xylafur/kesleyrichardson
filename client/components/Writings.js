...
class Writings extends React.Component {
  ...
  render () {
    return (
      <div style={{"backgroundImage": `url(${this.props.layer4})`, "backgroundSize":"cover", "opacity": `${this.props.layer4 ? 0.7 : 0.4}`, "backgroundAttachment": "fixed", "backgroundRepeat": "no-repeat"}}>
      <div className="writings overlay5">
        ...
        <h3 className="writings-quote">"I WAS BORN ALONG A DASHED, YELLOWLINE THAT RUNS STRAIGHT THROUGH THE HIGHWAY IN A LAND THAT ISN'T MINE."</h3>
