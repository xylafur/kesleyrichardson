...
class Shows extends React.Component {
  ...
  render () {
    return (
        <div style={{"backgroundImage": "url(" + "'" + layer2 + "')", "backgroundSize":"cover", "backgroundColor": "rgba(0,0,0, 1)", "opacity": "0.8", "backgroundAttachment": "fixed", "backgroundRepeat": "no-repeat", "backgroundSize": "cover", "textAlign": "center"}} className="overlay2">
